...
--
-- Name: demo_hotel; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.demo_hotel (
    id uuid NOT NULL,
    exchange_rate json,
    surcharge_exchange_rate json,
    sort integer,
    surcharge_margin_percentage real,
    user_created uuid,
    margin_percentage real,
    surcharge_percentage_type character varying(255) DEFAULT NULL::character varying,
    date_created timestamp with time zone,
    percentage_type character varying(255) DEFAULT NULL::character varying,
    surcharge_provision_percentage real,
    user_updated uuid,
    provision_percentage real,
    date_updated timestamp with time zone,
    name character varying(255) DEFAULT NULL::character varying,
    special json,
    buy_price_type character varying(255) DEFAULT NULL::character varying,
    sell_price_type character varying(255) DEFAULT NULL::character varying,
    from_price uuid
);
...
CREATE TABLE public.directus_flows (
    ...
    flow_manager_last_run_message text DEFAULT ''::text,
    flow_manager_last_run_operation character varying(255) DEFAULT ''::character varying
);
...
CREATE TABLE public.occupancies (
    ...
    hotel_id uuid,
    value integer,
    from_price boolean DEFAULT false
);


--
-- Name: price_dates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.price_dates (
    id uuid NOT NULL,
    sort integer,
    user_created uuid,
    date_created timestamp with time zone,
...
--
-- Name: room_prices; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.room_prices (
    ...
    price_date_id uuid,
    occupancy_id uuid,
    buy_price numeric(10,2) DEFAULT NULL::numeric,
    sell_price numeric(10,2) DEFAULT NULL::numeric
);
...
CREATE TABLE public.surcharges (
    ...
    hotel_id uuid,
    name character varying(255) DEFAULT NULL::character varying,
    buy_price numeric(10,5) DEFAULT NULL::numeric,
    sell_price numeric(10,5) DEFAULT NULL::numeric,
    description_catalog_text text,
    name_original_andor_booking_code text
);
...
--
-- Name: demo_hotel demo_hotel_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.demo_hotel
    ADD CONSTRAINT demo_hotel_pkey PRIMARY KEY (id);
...
--
-- Name: price_dates price_dates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_dates
    ADD CONSTRAINT price_dates_pkey PRIMARY KEY (id);
...
--
-- Name: room_prices room_prices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: continents continents_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.continents
    ADD CONSTRAINT continents_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: continents continents_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.continents
    ADD CONSTRAINT continents_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: countries countries_continent_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.countries
    ADD CONSTRAINT countries_continent_id_foreign FOREIGN KEY (continent_id) REFERENCES public.continents(id) ON DELETE SET NULL;


--
-- Name: countries countries_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.countries
    ADD CONSTRAINT countries_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: countries countries_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.countries
    ADD CONSTRAINT countries_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: currencies currencies_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.currencies
    ADD CONSTRAINT currencies_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: currencies currencies_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.currencies
    ADD CONSTRAINT currencies_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: demo_hotel demo_hotel_from_price_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.demo_hotel
    ADD CONSTRAINT demo_hotel_from_price_foreign FOREIGN KEY (from_price) REFERENCES public.room_prices(id) ON DELETE SET NULL;


--
-- Name: demo_hotel demo_hotel_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.demo_hotel
    ADD CONSTRAINT demo_hotel_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: demo_hotel demo_hotel_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.demo_hotel
    ADD CONSTRAINT demo_hotel_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);
...
--
-- Name: occupancies occupancies_hotel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.occupancies
    ADD CONSTRAINT occupancies_hotel_id_foreign FOREIGN KEY (hotel_id) REFERENCES public.demo_hotel(id) ON DELETE CASCADE;


--
-- Name: occupancies occupancies_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.occupancies
    ADD CONSTRAINT occupancies_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: occupancies occupancies_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.occupancies
    ADD CONSTRAINT occupancies_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: price_dates price_dates_hotel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_dates
    ADD CONSTRAINT price_dates_hotel_id_foreign FOREIGN KEY (hotel_id) REFERENCES public.demo_hotel(id) ON DELETE CASCADE;


--
-- Name: price_dates price_dates_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_dates
    ADD CONSTRAINT price_dates_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: price_dates price_dates_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.price_dates
    ADD CONSTRAINT price_dates_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: rates rates_from_currency_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rates
    ADD CONSTRAINT rates_from_currency_foreign FOREIGN KEY (from_currency) REFERENCES public.currencies(id) ON DELETE SET NULL;


--
-- Name: rates rates_to_currency_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rates
    ADD CONSTRAINT rates_to_currency_foreign FOREIGN KEY (to_currency) REFERENCES public.currencies(id) ON DELETE SET NULL;


--
-- Name: rates rates_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rates
    ADD CONSTRAINT rates_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: rates rates_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rates
    ADD CONSTRAINT rates_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: room_categories room_categories_hotel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_categories
    ADD CONSTRAINT room_categories_hotel_id_foreign FOREIGN KEY (hotel_id) REFERENCES public.demo_hotel(id) ON DELETE CASCADE;


--
-- Name: room_categories room_categories_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_categories
    ADD CONSTRAINT room_categories_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: room_categories room_categories_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_categories
    ADD CONSTRAINT room_categories_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: room_prices room_prices_hotel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_prices
    ADD CONSTRAINT room_prices_hotel_id_foreign FOREIGN KEY (hotel_id) REFERENCES public.demo_hotel(id) ON DELETE SET NULL;


--
-- Name: room_prices room_prices_occupancy_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_prices
    ADD CONSTRAINT room_prices_occupancy_id_foreign FOREIGN KEY (occupancy_id) REFERENCES public.occupancies(id) ON DELETE SET NULL;


--
-- Name: room_prices room_prices_price_date_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_prices
    ADD CONSTRAINT room_prices_price_date_id_foreign FOREIGN KEY (price_date_id) REFERENCES public.price_dates(id) ON DELETE SET NULL;


--
-- Name: room_prices room_prices_room_category_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_prices
    ADD CONSTRAINT room_prices_room_category_id_foreign FOREIGN KEY (room_category_id) REFERENCES public.room_categories(id) ON DELETE SET NULL;


--
-- Name: room_prices room_prices_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_prices
    ADD CONSTRAINT room_prices_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: room_prices room_prices_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_prices
    ADD CONSTRAINT room_prices_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: state state_country_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.state
    ADD CONSTRAINT state_country_id_foreign FOREIGN KEY (country_id) REFERENCES public.countries(id) ON DELETE SET NULL;


--
-- Name: state state_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.state
    ADD CONSTRAINT state_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: state state_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.state
    ADD CONSTRAINT state_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: surcharges surcharges_hotel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.surcharges
    ADD CONSTRAINT surcharges_hotel_id_foreign FOREIGN KEY (hotel_id) REFERENCES public.demo_hotel(id) ON DELETE CASCADE;


--
-- Name: surcharges surcharges_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.surcharges
    ADD CONSTRAINT surcharges_user_created_foreign FOREIGN KEY (user_created) REFERENCES public.directus_users(id);


--
-- Name: surcharges surcharges_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.surcharges
    ADD CONSTRAINT surcharges_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);


--
-- Name: test test_user_created_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: test test_user_updated_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
