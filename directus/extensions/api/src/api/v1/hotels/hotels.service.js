...
export async function listHotels(
  ...
  const listFilter = buildListFilter({ search, country, hotel_group, hotel_classification, region, state, activity, season, status_primarix });
  ...
  const [rawItems, countResult] = await Promise.all([
    hotelsService.readByQuery({
      fields: ['id', 'name', 'object_id', 'date_updated', 'source_updated_at'],
      sort: buildSort(sort),
      limit,
      offset,
      filter,
