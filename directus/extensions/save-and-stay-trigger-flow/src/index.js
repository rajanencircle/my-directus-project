...
export default {
    ...
    icon: 'smart_button',
    description: 'Button that saves the item (Save & Stay) and optionally triggers a Directus Flow.',
    ...
    options: () => [
        ...
        },
        {
            ...
            meta: {
                width: 'full',
                interface: 'input',
                note: 'UUID of a Directus Flow with a Webhook or Manual trigger. The flow receives { collection, keys, data: { id } } in the body. Leave empty to only Save & Stay.',
