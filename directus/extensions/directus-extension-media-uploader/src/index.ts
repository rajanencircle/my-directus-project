  ...
  options: [
    ...
    },
    {
      ...
      meta: {
        ...
        note: 'JSON array of extra inputs on the Upload Files modal. Use type "checkbox-group" with field (directus_files column name), label, and options. Each option may be a string or { "label": "Map", "value": "map flag" }; stored values are sent as JSON.stringify(string[]) before the file binary. Add the same field on directus_files (e.g. flags as JSON). Clear to [] to hide.',
        width: "full",
      },
