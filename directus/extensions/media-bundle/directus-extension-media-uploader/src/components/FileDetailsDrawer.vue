    ...
    <v-card class="details-card">
      ...
      <v-card-text class="card-body">
        ...
        <template v-else>
          ...
          <div class="section">
            <div class="section-title">{{ lbl('drawerTabBasic', 'Basic') }}</div>
          ...
          <div class="section">
            <div class="section-title">{{ lbl('drawerTabIptc', 'Rights / IPTC') }}</div>
            <div class="details-grid">
          ...
          <div class="section">
            <div class="section-title">{{ lbl('drawerTabGeo', 'Geography') }}</div>
            <div class="details-grid">
          ...
          <div v-if="translations.length" class="section">
            <div class="section-title">{{ lbl('drawerIptcTitle', 'IPTC Caption') }}</div>
            <div class="table">
              <div class="tr th">
                <div class="td">{{ lbl('drawerIptcLanguage', 'Language') }}</div>
                <div class="td">{{ lbl('drawerIptcCaption', 'Caption') }}</div>
              </div>
