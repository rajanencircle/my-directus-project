...
**Fixed**: The "This interface requires a One-to-Many relationship to be configured" error. The extension now automatically detects relationships and has smart fallbacks.
...
- `FIELD_CONFIGURATION.md` - Step-by-step field setup guide
